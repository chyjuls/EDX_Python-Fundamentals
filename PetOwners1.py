...
# first and last name? #owner.name.first, owner.name.last
...
def get_owner_string(my_pet):
    pet_first = my_pet.name.first
    pet_last = my_pet.name.last
    owner_first = my_pet.owner.name.first
    owner_last = my_pet.owner.name.last
    pet_string = str(pet_first) + " " + str(pet_last) + """\'s """ + "owner is " + str(owner_first) + " " + str(
        owner_last) + "."
    return pet_string
