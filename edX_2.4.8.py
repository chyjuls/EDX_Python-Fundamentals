...
# the complicated formulae down into bite-sized little chunks.
...
first_part = (2 * Level + 10)/250

second_part = (Attack / Defense)

third_part = (first_part * second_part) * Base + 2


Damage = third_part * modifier
print(Damage)
