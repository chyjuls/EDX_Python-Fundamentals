...
def to_dictionaries(nation_list):
    ...
    for nation in nation_list:
        # creat inner dictionary
        nationDict = {}
        nationDict['long_name'] = nation.long_name
        nationDict['iso_code'] = nation.iso_code
        nationDict['iso_short'] = nation.iso_short
        nationDict['iso_long'] = nation.iso_long
        nationDict['capital'] = nation.capital

        # add inner dictionary in outer one
        result[nation.short_name] = nationDict
